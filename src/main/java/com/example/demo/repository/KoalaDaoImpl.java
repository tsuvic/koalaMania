...
public class KoalaDaoImpl implements KoalaDao{
	...
	public Koala findById(int id) {
		...
		Koala koala = new Koala(
				(int)oneKoala.get("koala_id"),
				(String)oneKoala.get("name"),
				(int)oneKoala.get("sex"),
				(Date)oneKoala.get("birthdate"),
				(int)oneKoala.get("is_alive"),
				(Date)oneKoala.get("deathdate"),
				(String)oneKoala.get("zoo"),
				(String)oneKoala.get("mother"),
				(String)oneKoala.get("father"),
				(String)oneKoala.get("details"),
				(String)oneKoala.get("feature")
		);
		for(Map<String, Object> result : resultList) {
		*/
